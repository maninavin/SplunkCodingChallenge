...
public class MovieTitleMatchTest {
	...
	public void testMoviesTitleMatch() {
		...
		assertTrue(MoviesInformationHelper.verifyMoviesTitlesMatch(js),
				"There are no two movies whose title contains title of another.");
